...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Handsome209/approval/blob/main/a.txt"])

	exit(" [*] FACEBOOK :  https://www.facebook.com/aliyanali.meranibaloch")
...
def notice():
	...
	runtxt("\033[0;92m BYPASS ADMIN MESSENGER >> m.me/aliyanali.meranibaloch")
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Handsome209/approval/blob/main/a.txt').text
...
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : All Fb Tricks By Mr Handsome  
...
\033[1;90m══════════════════════════════════════════════════
    ...
    """)
		...
		print("%s [%s•%s] %sSTATUS    : %sPREMIUM"%(G,R,G,B,stat)) 
